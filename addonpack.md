...
Just place the .vpk files in your custom folder, next to the solarlighthud-redux folder. Some people make the mistake of putting it inside the HUD folder, so don't do that.
